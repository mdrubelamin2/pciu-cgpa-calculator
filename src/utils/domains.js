...
export const PRIMARY_DOMAIN = process.env.NEXT_PUBLIC_PRIMARY_DOMAIN || 'https://pciu-result.vercel.app';

// Secondary domain is maintained for backward compatibility
export const SECONDARY_DOMAIN = process.env.NEXT_PUBLIC_SECONDARY_DOMAIN || 'https://pciu-cgpa-calculator.vercel.app';
