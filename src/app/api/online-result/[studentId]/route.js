...
export const GET = async (_, { params }) => {
    ...
    if (!requestVerificationToken || !semester) {
        console.warn(`Missing required tokens: requestVerificationToken=${!!requestVerificationToken}, semester=${!!semester}`)
    ...
    for (let i = 0; i < semestersList.length; i++) {
        ...
        try {
            ...
            console.warn(`Error processing semester ${currentSemester} for ${studentId}:`, error.message)
        }
    }
